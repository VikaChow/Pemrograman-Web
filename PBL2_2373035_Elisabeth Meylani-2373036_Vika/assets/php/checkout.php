...
$payment_method = $_POST['payment'] ?? null;  // payment method: transfer / cod / ewallet
...
try {
    ...
    $stmt_shipping = $conn->prepare("
        ...
        (order_id, recipient_name, phone, address, city, postal_code, payment_method) 
        VALUES (?, ?, ?, ?, ?, ?, ?)
    ");
    $stmt_shipping->bind_param("issssss", $order_id, $recipient_name, $phone, $address, $city, $postal_code, $payment_method);
